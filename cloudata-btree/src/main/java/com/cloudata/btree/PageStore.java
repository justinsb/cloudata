...
public abstract class PageStore implements Closeable {
     ...
     */
    abstract ListenableFuture<SpaceMapEntry> writePage(TransactionTracker tracker, long transactionId, Page page);
    ...
    protected abstract ByteSource asByteSource0() throws IOException;
}
