...
public class MmapPageStore extends PageStore {
    ...
    @Override
    ListenableFuture<SpaceMapEntry> writePage(TransactionTracker tracker, long transactionId, Page page) {
        ...
        PageHeader.write(writeBuffer, page.getPageType(), dataSize, transactionId);
    ...
    public ByteBufferByteSource asByteSource0() throws IOException {
      ByteBuffer b = this.buffer.duplicate();
      return new ByteBufferByteSource(b);
    }
