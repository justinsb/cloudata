...
public class TransactionTracker {
    ...
    ReadOnlyTransaction beginReadOnlyTransaction() {
        synchronized (this) {
            ...
            ReadOnlyTransaction txn = new ReadOnlyTransaction(db, currentRootPage, currentTransactionId, currentTransactionPageId);
    ...
    SpaceMapEntry commitTransaction(TransactionPage transactionPage) throws IOException {
        ...
        synchronized (this) {
            ...
            if (deferredReclaim.size() > 64) {
                ...
                SpaceMapEntry fsmPageId = writePageSync(transactionId, page);
            ...
            SpaceMapEntry transactionPageId = writePageSync(transactionId, transactionPage);
    ...
    private SpaceMapEntry writePageSync(long transactionId, Page page) throws IOException {
        return Futures.get(db.pageStore.writePage(this, transactionId, page), IOException.class);
    }
