...
import com.cloudata.blockstore.BlockStoreServer;
import com.google.common.collect.Lists;
import com.google.common.io.Files;

public class IntegrationTestBase {
    protected static BlockStoreServer[] SERVERS;
    static File TEMPDIR;
    ...
    public static void startServers() throws Exception {
        ...
        SERVERS = new BlockStoreServer[3];
        ...
        for (int i = 0; i < SERVERS.length; i++) {
            ...
            SERVERS[i] = new BlockStoreServer(baseDir, local, members, httpPort, redisAddress);
