...
// * password. This filter is intended only to protect the
// * {@link GitOverHttpServlet} and its handled URLs, which provide remote
...
//		final String expect = KD(H(A1), nonce + ":" + nc + ":" + cnonce + ":"
//				+ qop + ":" + H(A2));
//
...
//				context.log("Error validating nonce for digest authentication",
//						e);
